...
const isRealPalindrome = str => {
  ...
  const strippedString = str.replace(/[^0-9a-z]/gi, '').toLowerCase();
...
const showMultiplicativeAverage = arr => {
  ...
  // iterate through the inputArray
    // reassign productAccumulator to be productAccumulator multiplied with the array element
